...
export class Login implements OnInit {
  ...
  async cadastrarAluno(): Promise<void> {
    ...
    try {
      const res = await fetch('http://https://educainclusiva-backend-hvwz.onrender.com/cadastro/aluno', {
        method: 'POST',
  ...
  async cadastrarInstitucional(): Promise<void> {
    ...
    try {
      ...
      const res = await fetch(
        'http://https://educainclusiva-backend-hvwz.onrender.com/cadastro/institucional',
        {
          method: 'POST',
          headers: {
